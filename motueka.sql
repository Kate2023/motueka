...
CREATE TABLE IF NOT EXISTS booking (
  ...
  bookingextras text default Null,
  roomreview text default NULL,
  roomID  int NOT NULL,  
  customerID int NOT NULL,
  PRIMARY KEY (bookingID)
) AUTO_INCREMENT=1;
INSERT INTO booking (bookingID,checkindate,checkoutdate,contactnumber,bookingextras,roomreview,roomID,customerID) VALUES 
(1,"2023-12-09","2023-12-12","0221243267","N/A","N/A","8","16"),
(2,"2023-10-08","2023-10-10","0221245169","N/A","N/A","3","10");